          ...
          <transition name="menu-panel" @after-leave="onMenuClosed">
            <div v-if="showUserMenu" class="ios-panel" @click.stop>
              ...
              <div class="panel-menu-group">
                <div class="menu-item" @click="showProfile = false; showPref = true">
                  <div class="menu-icon-box prefs">
                    <el-icon :size="18"><Setting /></el-icon>
                  </div>
                  <div class="menu-text">
                    <span class="menu-title">系统偏好</span>
                    <span class="menu-desc">自定义主题外观</span>
                  </div>
...
import {
  ...
  Reading, Collection, ArrowDown, ArrowRight, SwitchButton, Setting
